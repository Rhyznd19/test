...
//     version 1.13.1
//     from Assets/Main/StarterAssets/InputSystem/StarterAssets.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Main/StarterAssets/InputSystem/StarterAssets.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""controlSchemes"": [
        ...
        ~@StarterInput()
        {
            UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, StarterInput.Player.Disable() has not been called.");
        }
